object CanDataSetupWin: TCanDataSetupWin
  Left = 1116
  Top = 1538
  AutoSize = True
  ...
  object CanIdStartEdit: TZahlen32Edit
    Left = 83
    Top = 106
    Width = 90
    Height = 24
  ...
  object CanMaskEndEdit: TZahlen32Edit
    Left = 267
    Top = 106
    Width = 90
    Height = 24
  ...
  object IdModeEdit: TRadioGroup
    ...
    Items.Strings = (
      ...
      'Masked')
    TabOrder = 10
    OnClick = IdModeEditClick
  end
  object MsgHitDisableBox: TCheckBox
    Left = 24
    Top = 352
    Width = 337
    Height = 17
    Caption = 'Nachricht nicht als bekannt markieren'
    TabOrder = 11
  end
end
