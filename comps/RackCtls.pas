...
procedure Register;
begin
  RegisterComponents('MHS', [TLEDButton]);
  RegisterComponents('MHS', [TButtonPanel]);
  RegisterComponents('MHS', [TScrewPanel]);
  RegisterComponents('MHS', [TLEDDisplay]);
  RegisterComponents('MHS', [TLEDMeter]);
end;
